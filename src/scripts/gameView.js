            ...
            draw: {
                value: function (objects) {
                    ...
                    if (validators.isArray(objects)) {
                        ...
                        // laser ray
                        context.beginPath();
                        lineToAngle(objects.position.x, objects.position.y, 2000, objects.angle +
                            (configuration.rayWidth.value / 4), context);
                        context.arc(objects.position.x, objects.position.y, 2000,
                            trigonometry.toRad(360 - objects.angle - (configuration.rayWidth.value / 4)),
                            trigonometry.toRad(360 - objects.angle + configuration.rayWidth.value / 2));
                        context.closePath();
                        ...
                        for (var j = -6; j < 6; j += 2) {
                            context.arc(objects.position.x, objects.position.y, objects.range + j,
                                trigonometry.toRad(360 - objects.angle - (configuration.rayWidth.value / 4)),
                                trigonometry.toRad(360 - objects.angle + configuration.rayWidth.value / 2));
                            context.closePath();
        ...
        Object.defineProperties(controlFieldViewInternal, {
            init: {
                value: function () {
                    ...
                    gameSettingsSlidersHolder.style.display = 'flex';
                    gameSettingsSlidersHolder.style.height = '40px';
                    gameSettingsSlidersHolder.style.width = '95%';
